<?php
    ...
    if (isset($_POST['id'])&&isset($_POST['degree'])&& isset($_POST['fee']))
    {
      $id=$_POST['id'];
      $degree=$_POST['degree'];
      $fee=$_POST['fee'];
  ...
  <body>
    ...
    >
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input name="degree" class="form-control form-control-lg" type="text" />
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Fee</label>
        <div class="col-sm-6">
          <input name="fee" class="form-control form-control-lg" type="text" />
        </div>
      </div>
