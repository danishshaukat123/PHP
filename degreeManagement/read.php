...
<div class="container">
    ...
    <div class="row">
        <div class="col heading"><H4>Degree Id</H4></div>
        <div class="col heading"><H4>Degree Name</H4></div>
        <div class="col heading"><H4>Fee</H4></div>
    ...
    <div class="row">
        ...
        <div class="col">
            <form method="POST" action="update.php">
                ...
                <input type="hidden" name="fee" value=<?php echo $row[2]; ?>>
        ...
        <div class="col">
            <form method="POST" action="addcourses.php">
                <input type="hidden" name="id" value=<?php echo $row[0]; ?>>
                <input type="hidden" name="name" value=<?php echo $row[1]; ?>>    
                <button style="background-color:#777DA7" type="submit"> Add Courses</button>
            </form>
        </div>
   </div>
